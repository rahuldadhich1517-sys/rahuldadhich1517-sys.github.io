...
const ReelsPage: React.FC = () => {
  useSEO({
    title: 'Instagram Reels — Rahul Dadhich',
    description: 'Short-form content about web development, design, career tips, and my journey as a developer.',
    url: 'https://rahuldadhich.dev/reels',
  });
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-base md:text-lg text-[#737373] leading-relaxed max-w-2xl">
            Short-form content about web development, design, and my journey as a developer.
          </p>
        </motion.div>
        ...
        >
          {filteredReels.map((reel) => (
            ...
            >
              {/* Thumbnail Area */}
              <div className="relative h-80 sm:h-96 bg-gradient-to-br from-[#F5F5F5] to-[#E8E1D5] flex items-center justify-center overflow-hidden">
